export const abi = [
  ...
  { inputs: [], name: "AmountExceedsAvailableSupply", type: "error" },
  { inputs: [], name: "AmountRequired", type: "error" },
  { inputs: [], name: "ApprovalCallerNotOwnerNorApproved", type: "error" },
  { inputs: [], name: "ApprovalQueryForNonexistentToken", type: "error" },
  { inputs: [], name: "BalanceQueryForZeroAddress", type: "error" },
  { inputs: [], name: "InsufficientFunds", type: "error" },
  { inputs: [], name: "InvalidQueryRange", type: "error" },
  { inputs: [], name: "MaxMintWouldBeExceeded", type: "error" },
